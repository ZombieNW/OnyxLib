...
const FeatureList = [
    {
        ...
        description: (
            <>
                OnyxLib is built with Minecraft fans and developers in mind.
                OnyxLib and your creations are built with Java and PaperMC.
            </>
        ),
    },
    {
        ...
        description: (
            <>
                Adding custom content like items is a breeze. Registering custom
                items with textures and a custom name can be done with a single
                builder method.
            </>
        ),
    },
